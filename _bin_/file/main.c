...
static void step1()
{
    ...
    printf(G "   Error\t=>\t" Y);
    fflush(stdout);
    system("./pushswap/push_swap 1 e");

    printf(B "2. ./push_swap 10 9 2 3 8 9 11\n" N);
    printf(G "   Error\t=>\t" Y);
    fflush(stdout);
    system("./pushswap/push_swap 10 9 2 3 8 9 11");

    printf(B "3. ./push_swap 2147483648\n" N);
    printf(G "   Error\t=>\t" Y);
    fflush(stdout);
    system("./pushswap/push_swap 2147483648");

    printf(B "4. ./push_swap -2147483649\n" N);
    printf(G "   Error\t=>\t" Y);
    fflush(stdout);
    system("./pushswap/push_swap -2147483649");

    printf(B "5. ./push_swap\n" N);
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap");
    printf(N "\n");
    ...
    printf(G "   Error\t=>\t" Y);
    fflush(stdout);
    system("./pushswap/push_swap 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
    printf(N "\n\n");
}
...
static void step2()
{
    ...
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap 42");
    printf(N "\n");

    printf(B "2. ./push_swap 2 3\n" Y);
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap 2 3");
    printf(N "\n");

    printf(B "3. ./push_swap 0 1 2 3\n" Y);
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap 0 1 2 3");
    printf(N "\n");

    printf(B "4. ./push_swap 0 1 2 3 4 5 6 7 8\n" Y);
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap 0 1 2 3 4 5 6 7 8");
    printf(N "\n");

    printf(B "4. ./push_swap 2 4 5 7 8\n" Y);
    printf(G "   \\n\t\t=>\t" Y "\\n");
    fflush(stdout);
    system("./pushswap/push_swap 2 4 5 7 8");
    printf(N "\n\n");
}
...
static void step3()
{
    ...
    printf(G "   OK\t=>\t" Y);
    fflush(stdout);
    system("ARG=\"2 1 0\"; ./pushswap/push_swap $ARG | _bin_/push_swap/checker_OS/" checker " $ARG");

    printf(B "2. ARG=\"10 9 2\"; ./push_swap $ARG | ./" checker " $ARG\n" Y);
    printf(G "   OK\t=>\t" Y);
    fflush(stdout);
    system("ARG=\"10 9 2\"; ./pushswap/push_swap $ARG | ./_bin_/push_swap/checker_OS/" checker " $ARG");

    printf(B "3. ARG=\"2 11 -15\"; ./push_swap $ARG | ./" checker " $ARG\n" Y);
    printf(G "   OK\t=>\t" Y);
    fflush(stdout);
    system("ARG=\"2 11 -15\"; ./pushswap/push_swap $ARG | ./_bin_/push_swap/checker_OS/" checker " $ARG");
    printf(N "\n");
}
...
static void step4()
{
    ...
    printf(G "   OK\t=>\t" Y);
    fflush(stdout);
    system("ARG=\"1 5 2 4 3\"; ./pushswap/push_swap $ARG | ./_bin_/push_swap/checker_OS/" checker " $ARG");

    printf(B "2. ARG=\"1 -23 2 1111 3\"; ./push_swap $ARG | " checker " $ARG\n" Y);
    printf(G "   OK\t=>\t" Y);
    fflush(stdout);
    system("ARG=\"1 -23 2 1111 3\"; ./pushswap/push_swap $ARG | ./_bin_/push_swap/checker_OS/" checker " $ARG");
    printf(N "\n");
...
static void step5()
{
    ...
    for (int i = 1; i <= 10; i++)
    {
        ...
        snprintf(command, sizeof(command), "./pushswap/push_swap %s | wc -l", line);
        ...
        if (count < best || best == 0)
            best = count;
        total += count;
        snprintf(command, sizeof(command), "ARG=\"%s\"; ./pushswap/push_swap $ARG | _bin_/push_swap/checker_OS/" checker " $ARG", line);
        printf( G "%d.\t" R "%d\t\t" Y, i, count);
        fflush(stdout);
        system(command);
        free(line);
    }
